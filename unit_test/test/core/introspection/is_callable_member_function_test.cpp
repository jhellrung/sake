...
BOOST_MPL_ASSERT((is_callable_mem_fun_x< yes_x1 const, int& ( ) >));
BOOST_MPL_ASSERT((is_callable_mem_fun_x< yes_x1 const, int const & ( ) >));
BOOST_MPL_ASSERT((is_callable_mem_fun_x< yes_x1, int ( ) >));
BOOST_MPL_ASSERT_NOT((is_callable_mem_fun_x< yes_x1, void ( ) >));
BOOST_MPL_ASSERT_NOT((is_callable_mem_fun_x< yes_x1, int const & ( int ) >));

struct yes_x2 { void x(int); };
BOOST_MPL_ASSERT((is_callable_mem_fun_x< yes_x2 >));
BOOST_MPL_ASSERT((is_callable_mem_fun_x< yes_x2, void ( int ) >));
BOOST_MPL_ASSERT((is_callable_mem_fun_x< yes_x2, void ( short ) >));
BOOST_MPL_ASSERT_NOT((is_callable_mem_fun_x< yes_x2 const, void ( int ) >));
BOOST_MPL_ASSERT_NOT((is_callable_mem_fun_x< yes_x2, void ( ) >));
BOOST_MPL_ASSERT_NOT((is_callable_mem_fun_x< yes_x2, void ( void* ) >));
BOOST_MPL_ASSERT_NOT((is_callable_mem_fun_x< yes_x2, int ( int ) >));

struct yes_x3 { int x(int); };
BOOST_MPL_ASSERT((is_callable_mem_fun_x< yes_x3 >));
BOOST_MPL_ASSERT((is_callable_mem_fun_x< yes_x3, int ( int ) >));
BOOST_MPL_ASSERT((is_callable_mem_fun_x< yes_x3, void ( short ) >));
BOOST_MPL_ASSERT((is_callable_mem_fun_x< yes_x3, long ( short ) >));
BOOST_MPL_ASSERT_NOT((is_callable_mem_fun_x< yes_x3 const, int ( int ) >));
