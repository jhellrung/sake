...
struct X_static_mem_fn { static void x(); };
struct X_static_mem_fn_template { template< class T > static void x(T); };
...
BOOST_STATIC_ASSERT( (has_member< X_static_mem_fn          >::value));
BOOST_STATIC_ASSERT( (has_member< X_static_mem_fn_template >::value));
...
BOOST_STATIC_ASSERT(!(has_type< X_static_mem_fn          >::value));
BOOST_STATIC_ASSERT(!(has_type< X_static_mem_fn_template >::value));
...
BOOST_STATIC_ASSERT(!(has_class_template< X_mem_fn                 >::value));
BOOST_STATIC_ASSERT(!(has_class_template< X_mem_fn_template        >::value));
BOOST_STATIC_ASSERT(!(has_class_template< X_static_mem_fn          >::value));
BOOST_STATIC_ASSERT(!(has_class_template< X_static_mem_fn_template >::value));
