/*******************************************************************************
 * sake/core/utility/workaround.hpp
 *
 ...
 * #define SAKE_WORKAROUND_EXPR_UNLESS_MSC_VERSION_LESS_EQUAL( version, Expr )
 * #define SAKE_WORKAROUND_COMMA_EXPR_IF_MSC_VERSION_LESS_EQUAL( version, Expr )
 * #define SAKE_WORKAROUND_COMMA_EXPR_UNLESS_MSC_VERSION_LESS_EQUAL( version, Expr )
 *
...
#define SAKE_WORKAROUND_MSC_VERSION_LESS_EQUAL( version ) \
    BOOST_PP_CAT( SAKE_WORKAROUND_MSC_VERSION_LESS_EQUAL_, version )

#if   _MSC_VER == 1300 // MSVC 7.0 / VS 2003
#define SAKE_WORKAROUND_MSC_VERSION_LESS_EQUAL_1300 1
#define SAKE_WORKAROUND_MSC_VERSION_LESS_EQUAL_1310 1
#define SAKE_WORKAROUND_MSC_VERSION_LESS_EQUAL_1400 1
#define SAKE_WORKAROUND_MSC_VERSION_LESS_EQUAL_1500 1
#define SAKE_WORKAROUND_MSC_VERSION_LESS_EQUAL_1600 1
#define SAKE_WORKAROUND_MSC_VERSION_LESS_EQUAL_1700 1
#elif _MSC_VER == 1310 // MSVC 7.1 / VS 2003 1.0
#define SAKE_WORKAROUND_MSC_VERSION_LESS_EQUAL_1300 0
#define SAKE_WORKAROUND_MSC_VERSION_LESS_EQUAL_1310 1
#define SAKE_WORKAROUND_MSC_VERSION_LESS_EQUAL_1400 1
#define SAKE_WORKAROUND_MSC_VERSION_LESS_EQUAL_1500 1
#define SAKE_WORKAROUND_MSC_VERSION_LESS_EQUAL_1600 1
...
#define SAKE_WORKAROUND_MSC_VERSION_LESS_EQUAL_1300 0
#define SAKE_WORKAROUND_MSC_VERSION_LESS_EQUAL_1310 0
#define SAKE_WORKAROUND_MSC_VERSION_LESS_EQUAL_1400 1
#define SAKE_WORKAROUND_MSC_VERSION_LESS_EQUAL_1500 1
#define SAKE_WORKAROUND_MSC_VERSION_LESS_EQUAL_1600 1
#define SAKE_WORKAROUND_MSC_VERSION_LESS_EQUAL_1700 1
...
#define SAKE_WORKAROUND_MSC_VERSION_LESS_EQUAL_1300 0
#define SAKE_WORKAROUND_MSC_VERSION_LESS_EQUAL_1310 0
#define SAKE_WORKAROUND_MSC_VERSION_LESS_EQUAL_1400 0
#define SAKE_WORKAROUND_MSC_VERSION_LESS_EQUAL_1500 1
#define SAKE_WORKAROUND_MSC_VERSION_LESS_EQUAL_1600 1
#define SAKE_WORKAROUND_MSC_VERSION_LESS_EQUAL_1700 1
...
#define SAKE_WORKAROUND_MSC_VERSION_LESS_EQUAL_1310 0
#define SAKE_WORKAROUND_MSC_VERSION_LESS_EQUAL_1400 0
#define SAKE_WORKAROUND_MSC_VERSION_LESS_EQUAL_1500 0
#define SAKE_WORKAROUND_MSC_VERSION_LESS_EQUAL_1600 1
#define SAKE_WORKAROUND_MSC_VERSION_LESS_EQUAL_1700 1
#elif _MSC_VER == 1700 // MSVC 11.0 / VS 11
#define SAKE_WORKAROUND_MSC_VERSION_LESS_EQUAL_1300 0
#define SAKE_WORKAROUND_MSC_VERSION_LESS_EQUAL_1310 0
#define SAKE_WORKAROUND_MSC_VERSION_LESS_EQUAL_1400 0
#define SAKE_WORKAROUND_MSC_VERSION_LESS_EQUAL_1500 0
#define SAKE_WORKAROUND_MSC_VERSION_LESS_EQUAL_1600 0
#define SAKE_WORKAROUND_MSC_VERSION_LESS_EQUAL_1700 1
#else
...
#define SAKE_WORKAROUND_EXPR_IF_MSC_VERSION_LESS_EQUAL( version, Expr ) \
    BOOST_PP_EXPR_IIF( SAKE_WORKAROUND_MSC_VERSION_LESS_EQUAL( version ), Expr )
#define SAKE_WORKAROUND_EXPR_UNLESS_MSC_VERSION_LESS_EQUAL( version, Expr ) \
    BOOST_PP_EXPR_IIF( BOOST_PP_COMPL( SAKE_WORKAROUND_MSC_VERSION_LESS_EQUAL( version ) ), Expr )

#define SAKE_WORKAROUND_COMMA_EXPR_IF_MSC_VERSION_LESS_EQUAL( version, Expr ) \
    BOOST_PP_CAT( \
        SAKE_WORKAROUND_COMMA_EXPR_IF_MSC_VERSION_LESS_EQUAL_, \
        SAKE_WORKAROUND_MSC_VERSION_LESS_EQUAL( version ) \
    ) ( Expr )
#define SAKE_WORKAROUND_COMMA_EXPR_UNLESS_MSC_VERSION_LESS_EQUAL( version, Expr ) \
    BOOST_PP_CAT( \
        SAKE_WORKAROUND_COMMA_EXPR_IF_MSC_VERSION_LESS_EQUAL_, \
        BOOST_PP_COMPL( SAKE_WORKAROUND_MSC_VERSION_LESS_EQUAL( version ) ) \
    ) ( Expr )

#define SAKE_WORKAROUND_COMMA_EXPR_IF_MSC_VERSION_LESS_EQUAL_0( Expr )
#define SAKE_WORKAROUND_COMMA_EXPR_IF_MSC_VERSION_LESS_EQUAL_1( Expr ) , Expr

#else // #ifdef _MSC_VER

#define SAKE_WORKAROUND_MSC_VERSION_LESS_EQUAL( version ) 0
#define SAKE_WORKAROUND_EXPR_IF_MSC_VERSION_LESS_EQUAL( version, Expr )
#define SAKE_WORKAROUND_EXPR_UNLESS_MSC_VERSION_LESS_EQUAL( version, Expr ) Expr
#define SAKE_WORKAROUND_COMMA_EXPR_IF_MSC_VERSION_LESS_EQUAL( version, Expr )
#define SAKE_WORKAROUND_COMMA_EXPR_UNLESS_MSC_VERSION_LESS_EQUAL( version, Expr ) , Expr
