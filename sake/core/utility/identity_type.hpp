...
#define SAKE_IDENTITY_TYPE( T ) \
    SAKE_IDENTITY_TYPE_impl( T, SAKE_BOOST_EXT_PP_KEYWORD_REMOVE_PREFIX_TYPENAME( T ) )
#define SAKE_IDENTITY_TYPE_impl( T, U ) \
    BOOST_PP_CAT( SAKE_IDENTITY_TYPE_impl, BOOST_PP_IS_UNARY( U ) ) ( T, U )
#define SAKE_IDENTITY_TYPE_impl0( T, U ) T
#define SAKE_IDENTITY_TYPE_impl1( T, U ) \
