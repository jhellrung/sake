 ...
 *
 * #define SAKE_DEFINE_NATURAL_assign_body( r, T, base_seq, member_name_seq )
 ******************************************************************************/
...
#define SAKE_DEFINE_NATURAL_assign_body( r, T, base_seq, member_name_seq ) \
    BOOST_PP_SEQ_CAT( \
        ( SAKE_DEFINE_NATURAL_assign_body_ ) \
        ( SAKE_BOOST_EXT_PP_SEQ_IS_NIL( base_seq ) ) \
        ( SAKE_BOOST_EXT_PP_SEQ_IS_NIL( member_name_seq ) ) \
    ) ( r, T, base_seq, member_name_seq )

#define SAKE_DEFINE_NATURAL_assign_body_00( r, T, base_seq, member_name_seq ) \
    BOOST_PP_SEQ_FOR_EACH_R( r, SAKE_DEFINE_NATURAL_assign_base, ~, base_seq ) \
    BOOST_PP_SEQ_FOR_EACH_R( r, SAKE_DEFINE_NATURAL_assign_member, T, member_name_seq ) \
    return *this;

#define SAKE_DEFINE_NATURAL_assign_body_01( r, T, base_seq, member_name_seq ) \
    BOOST_PP_CAT( \
        SAKE_DEFINE_NATURAL_assign_body_01_, \
        BOOST_PP_EQUAL( 1, BOOST_PP_SEQ_SIZE( base_seq ) ) \
    ) ( r, base_seq )
#define SAKE_DEFINE_NATURAL_assign_body_01_0( r, base_seq ) \
    BOOST_PP_SEQ_FOR_EACH_R( r, SAKE_DEFINE_NATURAL_assign_base, ~, base_seq ) \
    return *this;
#define SAKE_DEFINE_NATURAL_assign_body_01_1( r, base_seq ) \
...
#define SAKE_DEFINE_NATURAL_assign_body_10( r, T, base_seq, member_name_seq ) \
    BOOST_PP_SEQ_FOR_EACH_R( r, SAKE_DEFINE_NATURAL_assign_member, T, member_name_seq ) \
    return *this;

#define SAKE_DEFINE_NATURAL_assign_body_11( r, T, base_seq, member_name_seq ) \
    return *this;
