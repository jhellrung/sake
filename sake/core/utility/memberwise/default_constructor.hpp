/*******************************************************************************
 * sake/core/utility/memberwise/default_constructor.hpp
 *
...
#ifndef SAKE_CORE_UTILITY_MEMBERWISE_DEFAULT_CONSTRUCTOR_HPP
#define SAKE_CORE_UTILITY_MEMBERWISE_DEFAULT_CONSTRUCTOR_HPP
...
#define SAKE_MEMBERWISE_DEFAULT_CONSTRUCTOR_impl( r, T, member_seq ) \
    ...
    static bool const has_default_constructor_tag_value = \
        BOOST_PP_CAT( \
            SAKE_MEMBERWISE_DEFAULT_CONSTRUCTOR_any_has_default_constructor_, \
...
#define SAKE_MEMBERWISE_DEFAULT_CONSTRUCTOR_any_has_default_constructor_0( r, member_seq ) \
    BOOST_PP_CAT( \
        SAKE_MEMBERWISE_DEFAULT_CONSTRUCTOR_any_has_default_constructor_0, \
        BOOST_PP_EQUAL( 1, BOOST_PP_SEQ_SIZE( member_seq ) ) \
    ) ( r, member_seq )
#define SAKE_MEMBERWISE_DEFAULT_CONSTRUCTOR_any_has_default_constructor_00( r, member_seq ) \
    ::sake::boost_ext::mpl::BOOST_PP_CAT( and, BOOST_PP_SEQ_SIZE( member_seq ) )< \
        BOOST_PP_SEQ_FOR_EACH_I_R( r, \
            SAKE_MEMBERWISE_DEFAULT_CONSTRUCTOR_comma_has_default_constructor, ~, member_seq ) \
    >::value
#define SAKE_MEMBERWISE_DEFAULT_CONSTRUCTOR_comma_has_default_constructor( r, data, i, elem ) \
    BOOST_PP_COMMA_IF( i ) ::sake::has_default_constructor< BOOST_PP_SEQ_HEAD( elem ) >
#define SAKE_MEMBERWISE_DEFAULT_CONSTRUCTOR_any_has_default_constructor_01( r, member_seq ) \
    ::sake::has_default_constructor< BOOST_PP_SEQ_HEAD( BOOST_PP_SEQ_HEAD( member_seq ) ) >::value

#define SAKE_MEMBERWISE_DEFAULT_CONSTRUCTOR_any_has_default_constructor_1( r, member_seq ) \
    true
...
#endif // #ifndef SAKE_CORE_UTILITY_MEMBERWISE_DEFAULT_CONSTRUCTOR_HPP
