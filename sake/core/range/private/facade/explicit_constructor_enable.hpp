/*******************************************************************************
 * sake/core/range/private/facade/explicit_constructor_enable.hpp
 *
...
#ifndef SAKE_CORE_RANGE_PRIVATE_FACADE_EXPLICIT_CONSTRUCTOR_ENABLE_HPP
#define SAKE_CORE_RANGE_PRIVATE_FACADE_EXPLICIT_CONSTRUCTOR_ENABLE_HPP
...
template<
    ...
    bool = boost::mpl::has_key<
        P, sake::range::keyword::tag::chained_base >::value
>
...
struct explicit_constructor_enable_dispatch< D, P, T, true >
    : boost_ext::mpl::and2<
          boost::mpl::not_< boost_ext::is_base_of_sans_qualifiers<
              sake::range::facade_adl::facade<D,P>, T > >,
          sake::value_constructor_enable<
              typename boost_ext::mpl::at<
                  P, sake::range::keyword::tag::chained_base >::type,
              T
          >
      >
{ };
...
#endif // #ifndef SAKE_CORE_RANGE_PRIVATE_FACADE_EXPLICIT_CONSTRUCTOR_ENABLE_HPP
