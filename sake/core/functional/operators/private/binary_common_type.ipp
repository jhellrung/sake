/*******************************************************************************
 * sake/core/functional/operators/private/binary_common_type.ipp
 *
...
class helper
{
    ...
    typedef typename boost_ext::common_type< noqual0_type, noqual1_type >::type maybe_type;
...
struct SAKE_OPERATORS_NAME
{
    ...
    typedef typename boost_ext::common_type< T0, T1 >::type type;
};
