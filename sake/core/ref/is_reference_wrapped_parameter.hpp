 ...
 * struct extension::is_reference_wrapped_parameter< T, Enable = void >
 * struct default_impl::is_reference_wrapped_parameter<T>
 ******************************************************************************/
...
struct is_reference_wrapped_parameter
    : extension::is_reference_wrapped_parameter<
...
struct is_reference_wrapped_parameter
    : default_impl::is_reference_wrapped_parameter<T>
{ };
