...
private:
    typedef typename boost::mpl::if_c<
        boost::mpl::has_key< Tags, ref_tag::implicitly_convertible >::value,
...
public:
    ...
    reference_wrapper(reference_wrapper< T2, Tags2 > other,
        typename boost::enable_if_c< boost_ext::is_convertible< T2*, T* > >::type* = 0);
    template< class T2 >
...
private:
    ...
    SAKE_USING_TYPENAME( typename reference_wrapper_private::traits< T, Tags >, forwarding_base );
...
struct is_reference_wrapped_parameter< reference_wrapper< T, Tags >, void >
    : boost::mpl::has_key< Tags, ref_tag::parameter >
{ };
    ...
    typedef forwarding::base<
        ...
        typename forwarding::deduced_params<
            ...
            typename boost::mpl::if_c<
                boost_ext::mpl::or2<
                    boost::mpl::has_key< Tags, ref_tag::assignable >,
                    boost::mpl::has_key< Tags, ref_tag::default_constructible >
                >::value,
                void,
...
reference_wrapper()
    : mp(nullptr)
{ BOOST_STATIC_ASSERT((boost::mpl::has_key< Tags, ref_tag::default_constructible >::value)); }
