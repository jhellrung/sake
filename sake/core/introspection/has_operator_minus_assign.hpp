/*******************************************************************************
 * sake/core/introspection/has_operator_minus_assign.hpp
 *
...
#ifndef SAKE_CORE_INTROSPECTION_HAS_OPERATOR_MINUS_ASSIGN_HPP
#define SAKE_CORE_INTROSPECTION_HAS_OPERATOR_MINUS_ASSIGN_HPP

#include <sake/boost_ext/type_traits/add_reference.hpp>

#include <sake/core/introspection/has_operator_binary.hpp>
#include <sake/core/introspection/private/builtin_has_operator_minus.hpp>
#include <sake/core/introspection/private/builtin_has_operator_op_assign.hpp>

namespace sake
{

#define SAKE_INTROSPECTION_TRAIT_NAME    has_operator_minus_assign
...
#define SAKE_INTROSPECTION_BUILTIN_HAS_OPERATOR( T, U, Result, ResultPred ) \
    ::sake::introspection_private::builtin_has_operator_op_assign< \
        ::sake::introspection_private::builtin_has_operator_minus \
    >::apply< T, U, Result, ResultPred >
#include SAKE_INTROSPECTION_DEFINE_HAS_OPERATOR_BINARY()

} // namespace sake

#endif // #ifndef SAKE_CORE_INTROSPECTION_HAS_OPERATOR_MINUS_ASSIGN_HPP
