/*******************************************************************************
 * sake/core/introspection/has_operator_unary_plus.hpp
 *
...
#define SAKE_INTROSPECTION_BUILTIN_HAS_OPERATOR( T, Result, ResultPred ) \
    ::sake::introspection_private::builtin_has_operator_unary_sign< T, Result, ResultPred >
#include SAKE_INTROSPECTION_DEFINE_HAS_OPERATOR_UNARY()

} // namespace sake

#endif // #ifndef SAKE_CORE_INTROSPECTION_HAS_OPERATOR_UNARY_PLUS_HPP
