/*******************************************************************************
 * core/introspection/private/builtin_has_operator_post_decrement.hpp
 *
...
template< class T, class Result, class ResultMetafunction >
struct builtin_has_operator_post_decrement< T&, Result, ResultMetafunction >
    : builtin_has_operator_post_crement< T&, Result, ResultMetafunction >
{ };

template< class Result, class ResultMetafunction >
struct builtin_has_operator_post_decrement< bool&, Result, ResultMetafunction >
    : boost::false_type
{ };
