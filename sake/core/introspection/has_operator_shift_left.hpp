...
#define SAKE_INTROSPECTION_OPERATOR_DECLARE( Result, T, U ) Result operator<<( T, U );
#define SAKE_INTROSPECTION_OPERATOR_APPLY( x, y )           x << y
#define SAKE_INTROSPECTION_DEFAULT_RESULT( T, U )           typename ::sake::boost_ext::remove_qualifiers<T>::type
#define SAKE_INTROSPECTION_BUILTIN_HAS_OPERATOR( T, U, Result, ResultCond ) \
    ::sake::introspection_private::builtin_has_operator_shift< T, U, Result, ResultCond >
