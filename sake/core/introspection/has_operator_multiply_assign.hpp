/*******************************************************************************
 * sake/core/introspection/has_operator_multiply_assign.hpp
 *
 * Copyright 2011, Jeffrey Hellrung.
 * Distributed under the Boost Software License, Version 1.0.  (See accompanying
 * file LICENSE_1_0.txt or copy at http://www.boost.org/LICENSE_1_0.txt)
 *
 * struct has_operator_multiply_assign<
 *     T, U,
...
#ifndef SAKE_CORE_INTROSPECTION_HAS_OPERATOR_MULTIPLY_ASSIGN_HPP
#define SAKE_CORE_INTROSPECTION_HAS_OPERATOR_MULTIPLY_ASSIGN_HPP
...
#define SAKE_INTROSPECTION_TRAIT_NAME    has_operator_multiply_assign
...
#define SAKE_INTROSPECTION_BUILTIN_HAS_OPERATOR( T, U, Result, ResultPred ) \
    ::sake::introspection_private::builtin_has_operator_op_assign< \
        ::sake::introspection_private::builtin_has_operator_arithmetic \
    >::apply< T, U, Result, ResultPred >
#include SAKE_INTROSPECTION_DEFINE_HAS_OPERATOR_BINARY()

} // namespace sake

#endif // #ifndef SAKE_CORE_INTROSPECTION_HAS_OPERATOR_MULTIPLY_ASSIGN_HPP
