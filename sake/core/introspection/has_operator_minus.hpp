/*******************************************************************************
 * sake/core/introspection/has_operator_minus.hpp
 *
...
#ifndef SAKE_CORE_INTROSPECTION_HAS_OPERATOR_MINUS_HPP
#define SAKE_CORE_INTROSPECTION_HAS_OPERATOR_MINUS_HPP
...
#define SAKE_INTROSPECTION_TRAIT_NAME    has_operator_minus
...
#define SAKE_INTROSPECTION_BUILTIN_HAS_OPERATOR( T, U, Result, ResultMetafunction ) \
    ::sake::introspection_private::builtin_has_operator_minus< T, U, Result, ResultMetafunction >
#include SAKE_INTROSPECTION_DEFINE_HAS_OPERATOR_BINARY()

} // namespace sake

#endif // #ifndef SAKE_CORE_INTROSPECTION_HAS_OPERATOR_MINUS_HPP
