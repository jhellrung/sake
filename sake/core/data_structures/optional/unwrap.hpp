...
template< class T >
inline typename sake::result_of::unwrap_optional< sake::optional<T>& >::type
unwrap_optional(sake::optional<T>& x)
{ return *x; }

template< class T >
inline typename sake::result_of::unwrap_optional< sake::optional<T> const & >::type
unwrap_optional(sake::optional<T> const & x)
{ return *x; }

template< class T >
inline typename sake::result_of::unwrap_optional< optional<T> >::type
