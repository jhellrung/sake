...
public:
    ...
    at(sake::begin_tag, Introversal = sake::null_introversal_tag()) const
    ...
    template< class Introversal >
    typename begin_introversal_base_::template relax< Introversal >::type
    begin(Introversal = sake::null_introversal_tag()) const
...
public:
    ...
    difference_type operator-(sake::begin_tag) const
