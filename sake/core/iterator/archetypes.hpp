...
#define access_constness BOOST_PP_SEQ_ELEM( N2, accesses )
#define access           BOOST_PP_TUPLE_ELEM( 2, 0, access_constness )
#define constness        BOOST_PP_TUPLE_ELEM( 2, 1, access_constness )
