...
struct clamp_ip
{
    ...
    T&
    operator()(SAKE_FWD_REF( L ) lower, T& x, SAKE_FWD_REF( U ) upper) const
    {
    ...
    T&
    operator()(SAKE_FWD_REF( L ) lower, T& x, SAKE_FWD_REF( U ) upper, Less less) const
    {
    ...
    T&
    operator()(SAKE_FWD_REF( L ) lower, T& x, sake::unbounded_tag) const
    { return !(x < lower) ? x : x = sake::forward<L>(lower); }

    template< class L, class T, class Less >
    T&
    operator()(SAKE_FWD_REF( L ) lower, T& x, sake::unbounded_tag, Less less) const
    { return !less(x, lower) ? x : x = sake::forward<L>(lower); }

    template< class T, class U >
    T&
    operator()(sake::unbounded_tag, T& x, SAKE_FWD_REF( U ) upper) const
    { return !(upper < x) ? x : x = sake::forward<U>(upper); }

    template< class T, class U, class Less >
    T&
    operator()(sake::unbounded_tag, T& x, SAKE_FWD_REF( U ) upper, Less less) const
