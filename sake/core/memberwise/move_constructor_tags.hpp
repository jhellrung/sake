/*******************************************************************************
 * sake/core/memberwise/move_constructor_tags.hpp
 *
 * Copyright 2012, Jeffrey Hellrung.
 * Distributed under the Boost Software License, Version 1.0.  (See accompanying
 * file LICENSE_1_0.txt or copy at http://www.boost.org/LICENSE_1_0.txt)
 *
 * #define SAKE_MEMBERWISE_MOVE_CONSTRUCTOR_TAGS[_R]( [r,] member_seq )
 ******************************************************************************/
...
#define SAKE_MEMBERWISE_MOVE_CONSTRUCTOR_TAGS( member_seq ) \
    SAKE_MEMBERWISE_MOVE_CONSTRUCTOR_TAGS_R( BOOST_PP_DEDUCE_R(), member_seq )

#define SAKE_MEMBERWISE_MOVE_CONSTRUCTOR_TAGS_R( r, member_seq ) \
