/*******************************************************************************
 * boost_ext/fusion/sequence/intrisic/begin.hpp
 *
...
class begin
{
    typedef typename boost::fusion::result_of::begin< Sequence >::type begin_it_type;
...
template< class Sequence >
class begin< Sequence& >
    : public boost::fusion::result_of::begin< Sequence >
{ };
