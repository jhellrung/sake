...
struct dispatch< I0, I1, sake::functional::cmp, false, false >
{
  typedef boost::mpl::int_<
    sake::static_sign_c<
      boost::fusion::result_of::distance< I0, I1 >::type::value >::value > type;
  static type apply(I0 const & /*i0*/, I1 const & /*i1*/,
    sake::functional::cmp)
  { return type(); }
};
...
struct dispatch< Sequence0, Sequence1, Cmp, true, true >
{
  ...
  static type apply(Sequence0 const & s0, Sequence1 const & s1,
    Cmp const & cmp_)
  {
    return cmp_private::iterate<N,S>(
      boost::fusion::begin(s0), boost::fusion::begin(s1), cmp_);
  }
};
