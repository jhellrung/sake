 ...
 *
 * boost_ext::fusion::not_equal(
 *   Sequence0 const & s0, Sequence1 const & s1)
 *   -> boost_ext::fusion::result_of::not_equal< Sequence0, Sequence1 >::type
 * boost_ext::fusion::not_equal(
 *   Sequence0 const & s0, Sequence1 const & s1, NotEqual not_equal_)
 *   -> boost_ext::fusion::result_of::not_equal< Sequence0, Sequence1, NotEqual >::type
 * boost_ext::fusion::not_equal(
 *   I0 const & i0, I1 const & i1)
...
struct dispatch0< I0, I1, sake::operators::functional::not_equal, false, false >
{
  ...
  > type;
  static type apply(I0 const & /*i0*/, I1 const & /*i1*/,
    sake::operators::functional::not_equal)
  { return type(); }
};
...
struct dispatch1
{
  ...
  static type apply(Sequence0 const & /*s0*/, Sequence1 const & /*s1*/,
    NotEqual const & /*not_equal_*/)
  {
...
struct dispatch1< Sequence0, Sequence1, NotEqual, N, N >
{
  ...
  static type apply(Sequence0 const & s0, Sequence1 const & s1,
    NotEqual const & not_equal_)
  {
    return not_equal_private::iterate<N>(
      boost::fusion::begin(s0), boost::fusion::begin(s1), not_equal_);
  }
};
...
struct iterate_dispatch
{
  ...
  typedef typename boost_ext::
    common_result_type< curr_type, next_type >::type type;
